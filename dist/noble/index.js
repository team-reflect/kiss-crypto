...
function generateEncryptionKey() {
    return (0, utils_2.generateRandomKey)(Defaults.EncryptionKeyLength);
}
...
function generateSalt() {
    return (0, utils_2.generateRandomKey)(Defaults.ArgonSaltLength);
}
...
function encrypt(_a) {
    ...
    var nonce = (0, utils_2.generateRandomKey)(Defaults.EncryptionNonceLength);
...
var encryptStringAsBlob = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, utils_2.stringToArrayBuffer)(plaintext)];
                case 1:
                    plainblob = _b.sent();
                    return [2 /*return*/, encryptBlob({ key: key, plainblob: plainblob })];
            }
        });
    });
};
...
function encryptBlob(_a) {
    ...
    var versionBuffer = (0, utils_1.utf8ToBytes)(Defaults.Version);
...
function decryptBlob(_a) {
    ...
    var versionBuffer = encryptedMessage.slice(0, Defaults.Version.length);
    var version = (0, utils_2.arrayBufferToString)(versionBuffer);
    if (version < Defaults.Version) {
        throw new Error("Invalid version: ".concat(version));
    }
    var nonceBuffer = encryptedMessage.slice(Defaults.Version.length, Defaults.Version.length + Defaults.EncryptionNonceLength);
    var cipherblob = encryptedMessage.slice(Defaults.Version.length + Defaults.EncryptionNonceLength);
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_e) {
            return [2 /*return*/, (0, hash_wasm_1.argon2id)({
                    password: password,
                    salt: (0, utils_1.hexToBytes)(salt),
